    ...
    def __initializeStoragePaths(cls) -> None:
        ...
        if not os.path.exists(cls.__config_storage_path) or not os.path.exists(cls.__data_storage_path):
            ...
            if is_alpha_version and QApplication.instance() is not None:
                ...
                message_box.setWindowTitle("Cura LulzBot Edition Alpha Version")
                message_box.setText("Starting an Alpha version of CuraLE without a configuration, do you want to import the configuration from the latest stable version or start a clean version ?")
